                                        ...
                                        <div class="cr-vendor-info">
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <div class="form-group p-b-15">
                                                        <input type="text" class="form-control"
                                                            placeholder="Enter number" value="+1 546 4548 878787">
                                                    </div>
                                                </li>
                                                <li class="mb-m-24">
                                            ...
                                            <li><strong>Email 1 : </strong>
                                                <div class="form-group">
                                                    <input type="email" class="form-control" placeholder="Enter email"
                                                        value="support1@exapmle.com">
                                                </div>
                                            </li>
                                            <li><strong>Email 2 : </strong>
                                                <div class="form-group">
                                                    <input type="email" class="form-control" placeholder="Enter email"
                                                        value="support2@exapmle.com">
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="cr-vendor-detail">
                                        ...
                                        <ul>
                                            <li><strong>Account Name : </strong>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" placeholder="Enter acc name"
                                                        value="Elizabeth Morgus">
                                                </div>
                                            </li>
                                            ...
                                            <li><strong>IFSC Code : </strong>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" placeholder="Enter acc ifsc"
                                                        value="123**********80">
                                                </div>
                                            </li>
                                            <li><strong>Bank name : </strong>
                                                <div class="form-group">
                                                    <input type="text" class="form-control"
                                                        placeholder="Enter bank name" value="Barky Central Bank">
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="cr-vendor-detail">
                                        ...
                                        <ul>
                                            <li><strong>Facebook</strong>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" placeholder="Faceboot id"
                                            ...
                                            <li><strong>Github</strong>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" placeholder="Github Id"
                                    ...
                                    <div class="cr-vendor-detail">
                                        ...
                                        <ul>
                                            ...
                                            <li><strong>Payoneer : </strong>
                                                <div class="form-group">
                                                    <input type="text" class="form-control" placeholder="Payoneer id"
                                                        value="support2@exapmle.com">
                                                </div>
                                            </li>
                                        </ul>
